...
public class UserReelsFragment extends Fragment {


    public UserReelsFragment() {
        // Required empty public constructor
    }

    String userUID;
    private ViewPager2 viewPager2;
    private UserReelsAdapter adapter;
    private final ArrayList<ExoPlayerItem> exoPlayerItems = new ArrayList<>();

    public UserReelsFragment(String userID) {
        userUID = userID;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflate = inflater.inflate(R.layout.fragment_user_reels, container, false);
        viewPager2 = inflate.findViewById(R.id.viewPager2);

        FirebaseController controller = new FirebaseController();

        controller.getMyReels(userUID, posts -> {
            adapter = new UserReelsAdapter(getContext(), posts, exoPlayerItems::add);
