...
public class MyReelsAdapter extends RecyclerView.Adapter<MyReelsAdapter.VideoViewHolder>{
    ...
    public MyReelsAdapter(Context context, ArrayList<UserPosts> videos, OnVideoPreparedListener videoPreparedListener) {
    ...
    @NonNull
    @Override
    public MyReelsAdapter.VideoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.user_reels_viewpager, parent, false);
        return new VideoViewHolder(v, context, videoPreparedListener);
    }

    @Override
    public void onBindViewHolder(@NonNull MyReelsAdapter.VideoViewHolder holder, int position) {
        ...
        holder.delete.setOnClickListener(v -> {
            controller.deleteUserReels(videos.get(position).getPostID(), videos.get(position).getPostImageURL(), response -> {
